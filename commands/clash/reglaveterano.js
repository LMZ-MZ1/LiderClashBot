...
• Los ascensos son responsabilidad exclusiva del líder 👑 @${lider.split('@')[0]} 
...
• Ayudar a mantener un ambiente sano en el clan es una de sus funciones principales como Veteranos
`.trim()
