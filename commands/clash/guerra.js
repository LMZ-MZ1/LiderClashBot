...
export default {
  ...
  run: async (client, m, args) => {
    ...
    try {
      ...
      text += `📋 *Actividad del clan (cada domingo en la noche todos deben tener min. 1000 puntos), se marca con un circulo rojo 🔴 a los que no llevan sus puntos y con un circulo verde 🟢 a los que si*\n`
