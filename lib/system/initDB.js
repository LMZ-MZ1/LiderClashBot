...
function initDB(m, client) {
  ...
  settings.id ??= '120363405348892234@newsletter'
  settings.nameid ??= 'LMZ Líder Bot'
  settings.type ??= 'Sub'
  settings.link ??= 'https://github.com/LMZ-MZ1'
  settings.banner ??= 'https://avatars.githubusercontent.com/u/55085359?s=400&u=1689c8f4829fedefa3dc21f12beb267b610ed056&v=4'
  settings.icon ??= 'https://avatars.githubusercontent.com/u/55085359?s=400&u=1689c8f4829fedefa3dc21f12beb267b610ed056&v=4'
  settings.currency ??= 'Coins'
  settings.namebot ??= 'LMZ Líder Bot'
  settings.namebot2 ??= 'LMZ Líder Bot'
  settings.owner ??= 'LMetalZoa'
  settings.canal ??= 'https://whatsapp.com/channel/0029VbCIgklJf05jQ1XFWB3j'
